        ...
        return (
            <div className="tictactoe">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><button onClick={this.chance} id="1" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                            <td><button onClick={this.chance} id="2" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                            <td><button onClick={this.chance} id="3" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                        </tr>
                        <tr>
                            <td><button onClick={this.chance} id="4" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                            <td><button onClick={this.chance} id="5" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                            <td><button onClick={this.chance} id="6" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                        </tr>
                        <tr>
                            <td><button onClick={this.chance} id="7" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                            <td><button onClick={this.chance} id="8" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                            <td><button onClick={this.chance} id="9" className="btn  btn-dark waves-effect">{this.state.spaces}</button></td>
                        </tr>
                        <tr>
